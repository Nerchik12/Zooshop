...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Следующие строки содержат сообщения об ошибках валидации.
    |
    */
    ...
    'distinct' => 'Значения поля :attribute повторяются.',
    ...
    'enum' => 'Значение поля :attribute отсутствует в списке допустимых.',
    ...
    'image' => 'В поле :attribute должно быть указано изображение.',
    'in' => 'Значение поля :attribute отсутствует в списке допустимых.',
    ...
    'mimes' => 'В поле :attribute должен быть указан файл одного из следующих типов: :values.',
    'mimetypes' => 'В поле :attribute должен быть указан файл одного из следующих типов: :values.',
    'min' => [
    ...
    'not_in' => 'Значение поля :attribute находится в списке недопустимых.',
    ...
    'url' => 'Значение поля :attribute не является ссылкой или имеет неверный формат.',
